...
<!-- Title Header Start -->
<section class="inner-header-title" style="background-image:url(/img/banner-10.jpg);">
    <div class="container">
        <h1>Blog Page</h1>
    </div>
</section>
        ...
        <div class="row .no-mrg">
            ...
            <div class="col-md-8">
                ...
                <article class="blog-news">
                    <div class="short-blog">
                        <figure class="img-holder">
                            <a href="blog-detail.html"><img src="/img/blog/1.jpg" class="img-responsive" alt="News"></a>
                ...
                <article class="blog-news">
                    <div class="short-blog">
                        <figure class="img-holder">
                            <a href="blog-detail.html"><img src="/img/blog/2.jpg" class="img-responsive" alt="News"></a>
                            <div class="blog-post-date">
                                Mar 12, 2017
                            </div>
                        </figure>
                ...
                <article class="blog-news">
                    <div class="short-blog">
                        <figure class="img-holder">
                            <a href="blog-detail.html"><img src="/img/blog/3.jpg" class="img-responsive" alt="News"></a>
                            <div class="blog-post-date">
                                Mar 12, 2017
                            </div>
                        </figure>
